...
class User(SqlAlchemyBase):
    ...
    is_accepted_to_paid_membership = sqlalchemy.Column(sqlalchemy.Boolean, default=False)
    subscription_till = sqlalchemy.Column(sqlalchemy.DATE)
    invited_by = sqlalchemy.Column(sqlalchemy.BigInteger)
    is_bot_blocked = sqlalchemy.Column(sqlalchemy.Boolean, default=False)
    applied_to_paid_membership = sqlalchemy.Column(sqlalchemy.Boolean, default=False)
